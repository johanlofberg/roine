...
/* 
<div id="myCarousel" className="carousel slide carousel slide carousel-fade" data-bs-ride="carousel">
  ...
  <div className="carousel-item active">
    ...
    <div className="container">
      <div className="carousel-caption text-start">
        <h1>Track</h1>
        <p>More or less preload in snow last winter?</p>
        <p>
  ...
  <div className="carousel-item">
    ...
    <div className="container">
      <div className="carousel-caption">
        <h1>Share</h1>
        <p>Let's not reinvent the wheel. Or fork.</p>
  ...
  <div className="carousel-item">
    ...
    <div className="container">
      <div className="carousel-caption text-end">
        <h1>Learn</h1>
        <p>Soft springs on cone valves?</p>
